#
#  Be sure to run `pod spec lint PNPForm.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "LabLamb"
  # spec.authors            = { "LabLamb" => "lablambworks@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/LabLamb"
